...
class ProductController extends AbstractController
{
    ...
    #[Route('/product/H', name: 'app_product_H', methods: ["GET"])]
    ...
    #[Route('/product/store', name: 'app_product/store', methods: ["POST"])]
    ...
    #[Route('/product/edit/{id}', name: 'app_product/edit', methods: ["POST"])]
    ...
    #[Route('/product/destroy/{id}', name: 'app_product_destroy', methods: ["DELETE"])]
