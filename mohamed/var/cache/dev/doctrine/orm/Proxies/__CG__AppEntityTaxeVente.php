 ...
 */
class TaxeVente extends \App\Entity\TaxeVente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TaxeVente' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TaxeVente' . "\0" . 'name', '' . "\0" . 'App\\Entity\\TaxeVente' . "\0" . 'products'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxeVente $proxy) {
