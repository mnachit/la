 ...
 */
class Gamme extends \App\Entity\Gamme implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Gamme' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Gamme' . "\0" . 'name', '' . "\0" . 'App\\Entity\\Gamme' . "\0" . 'products'];
        }
