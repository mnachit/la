 ...
 */
class TypeCompte extends \App\Entity\TypeCompte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\TypeCompte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\TypeCompte' . "\0" . 'name', '' . "\0" . 'App\\Entity\\TypeCompte' . "\0" . 'comptes'];
        }
